...
//
//        // initializing
//        author = new Author("Name", "Surname", "Patronymic", new Date());
//
...
//
//        dbPublisher.setBooks(List.of(book));
//
...
//        publisher.setBooks(dbPublisher.getBooks());
//
//        // assertion
//        Assertions.assertNotNull(dbPublisher);
//        Assertions.assertEquals(dbPublisher, publisher);
//        Assertions.assertEquals(dbPublisher.getBooks(), Set.of(book));
//
//        // clean
//        ServiceTestTools.deleteEntityById(dbBook.getId(), bookServiceImpl);
//
...
//        var dbBook = bookServiceImpl.create(book);
//        book.setId(dbBook.getId());
//        publisher.setBooks(dbBook.getPublisher().getBooks());
//
//        // assertion
//        Assertions.assertNotNull(dbBook);
...
//
//        Assertions.assertNotNull(dbPublisher);
//        Assertions.assertNotNull(dbPublisher.getBooks());
//        Assertions.assertFalse(dbPublisher.getBooks().isEmpty());
//
//        // clean database
//        ServiceTestTools.deleteAllEntities(List.of(publisherServiceImpl, bookServiceImpl, authorServiceImpl));
//    }
